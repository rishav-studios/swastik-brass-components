...
export const SectorsSection = ({
    ...
    const prevSector = sectors[activeIndex - 1];
    ...
    return (
        ...
        >
            ...
            {prevSector && (
                <link rel="preload" as="video" href={prevSector.videoSrc} />
            )}
            {nextSector && (
                <link rel="preload" as="video" href={nextSector.videoSrc} />
            )}
