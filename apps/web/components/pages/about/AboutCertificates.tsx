...
const AboutCertificates = () => {
    return (
        <Section className="bg-foreground hidden text-background relative py-24 lg:py-32 overflow-hidden">
            {/* Subtle Top Border */}
            ...
            <Container>
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-16">
                    <SectionHeader>
                        ...
                        <TextRevealOnScroll as="h2" className="leading-tight whitespace-pre-line" hiddenColor="#36332d" revealedColor="#fff" >
                            Globally Recognized
                            Standards.
                        </TextRevealOnScroll>
                    </SectionHeader>
                ...
                <div className="w-full">
                    <div className="flex gap-6 md:gap-8 w-max">
                        {CERTIFICATES.map((cert, idx) => (
                            <Fade key={idx} delay={0.1 + (idx * 0.1)} className="snap-center shrink-0 group">
