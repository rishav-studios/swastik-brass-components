    ...
    socials: [
        {
            ...
            label: "Whatsapp", href: "https://wa.me/9510626066"
        },
        {
            id: "f8f6c2c2-2d6dd7m",
            icon: <svg xmlns="http://www.w3.org/2000/svg" className="size-5 shrink-0" viewBox="0 0 640 640">
            ...
            label: "LinkedIn", href: "https://linkedin.com/company/swastik-brass-components"
        },
    ]
};
    ...
    return (
        <GridItem>
            ...
            <div className="space-y-4 text-background/80 w-max font-medium text-lg">
                ...
                <a href="mailto:savan@swastikbrasscomponents.com" className={combinedClasses}>
                    savan@swastikbrasscomponents.com
                </a>
                <a href="mailto:info@swastikbrasscomponents.com" className={combinedClasses}>
